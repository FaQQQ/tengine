...
rpm2cpio nginx-1.18.0-2.el7.ngx.x86_64.rpm | cpio -div
rm -rf nginx-1.18.0-2.el7.ngx.x86_64.rpm
...
mv ~/rpmbuild/RPMS/x86_64/${tengine_version}-2.el7.ngx.x86_64.rpm ~/

echo "执行 yum localinstall ~/${tengine_version}-2.el7.ngx.x86_64.rpm 安装 tengine"
